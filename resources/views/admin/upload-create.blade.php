...
<div class="card shadow-sm p-4 mx-auto" style="max-width: 600px;">
    <h5 class="fw-bold mb-4 text-center"><i class="bi bi-file-earmark-plus"></i> Tambah Dokumen Baru</h5>
    ...
    <form action="{{ route('upload.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <small class="text-muted">.pdf, .doc, .docx, .xls, .xlsx, .png, .jpg, .jpeg | Ukuran maksimal 4MB</small>
        </div>

        <div class="d-flex justify-content-between">
            <a href="{{ route('upload.index') }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Kembali</a>
            <button type="submit" class="btn btn-primary"><i class="bi bi-file-earmark-arrow-up-fill"></i> Upload Dokumen</button>
        </div>
    </form>
</div>
@endsection
